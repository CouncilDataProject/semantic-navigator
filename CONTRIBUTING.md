...
Ready to contribute? Here's how to set up `semantic-navigator` for local development.

1. Fork the `semantic-navigator` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/semantic-navigator.git
    ```
